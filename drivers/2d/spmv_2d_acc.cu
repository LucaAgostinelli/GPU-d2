/**
 * Identical 2D checkerboard partitioning/communication to
 * spmv_2d_cusparse.cu, ACC kernel instead of cuSPARSE
 *
 * Usage:
 *   mpirun -n <P> ./bin/spmv_2d_acc <matrix.mtx>
 */
#include <cstdio>
#include <cstdlib>
#include <string>
...
int main(int argc, char **argv)
{
    ...
    {
        if (rr == rank)
            print_result("checkerboard_mpi", "acc", path, size, rank,
