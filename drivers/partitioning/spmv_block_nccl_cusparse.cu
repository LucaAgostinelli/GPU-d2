/**
 * Twin of spmv_block_nccl_acc.cu -- IDENTICAL classical
 * 1D-Block partitioning and NCCL ghost-exchange transport, cuSPARSE instead
 * of ACC.
 *
 * Usage:
 *   mpirun -n <P> ./bin/spmv_block_nccl_cusparse <matrix.mtx>
 */
#include <cstdio>
#include <cstdlib>
#include <string>
...
int main(int argc, char **argv)
{
    ...
    {
        if (rr == rank)
            print_result("block_nccl", "cusparse", path, size, rank,
