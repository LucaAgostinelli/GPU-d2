/**
 * Twin of spmv_fennel_nccl_acc.cu -- IDENTICAL Fennel/LDG
 * partitioning and NCCL ghost-exchange transport, cuSPARSE instead of ACC.
 *
 * Usage:
 *   mpirun -n <P> ./bin/spmv_fennel_nccl_cusparse <matrix.mtx>
 */
#include <cstdio>
#include <cstdlib>
#include <string>
...
int main(int argc, char **argv)
{
    ...
    {
        if (rr == rank)
            print_result("fennel_nccl", "cusparse", path, size, rank,
